...
export default function AdminSettingsPage() {
  ...
  if (profileLoading) {
    return (
      <>
        <AppNav />
        <AdminLayout pageTitle="Settings" subtitle="Loading...">
  ...
  return (
    <>
      <AppNav />
      <AdminLayout pageTitle="Settings" subtitle="Platform configuration">
        <Card>
          <Stack spacing="md" className="py-8 text-center">
            <Text color="muted">No settings available yet</Text>
            <Text variant="small" color="muted">
              Platform settings will be added as needed.
            </Text>
          </Stack>
        </Card>
      </AdminLayout>
