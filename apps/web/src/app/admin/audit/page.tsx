...
export default function AdminAuditPage() {
  ...
  if (profileLoading) {
    return (
      <>
        <AppNav />
        <AdminLayout pageTitle="System Audit Log" subtitle="Loading...">
  ...
  return (
    <>
      <AppNav />
      <AdminLayout pageTitle="System Audit Log" subtitle="Platform-wide activity log">
        <Card>
          <Stack spacing="md" className="py-8 text-center">
            <Text color="muted">System audit log coming soon</Text>
            <Text variant="small" color="muted">
              This will show platform-wide moderation actions and admin activity.
            </Text>
          </Stack>
        </Card>
      </AdminLayout>
